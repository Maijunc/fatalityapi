...
public enum ResultCode {
    ...
    USER_IS_IN_GROUP(20009,"该用户已加入该小组"),
    ASSIGNMENT_NOT_EXIST(20010,"用户未加入该小组"),
    GROUP_IS_FULLED(20011,"小组已满员"),
    GROUP_IS_NOT_FULL(20012,"小组未满员"),
    GROUP_TASK_ASSIGNED(20013,"小组任务已经全部分配完毕"),
